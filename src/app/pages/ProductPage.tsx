        ...
        <div className="grid grid-cols-3 gap-16">
          ...
          <div className="col-span-2 space-y-12">
            ...
            <div>
              ...
              <h1 className="text-4xl mb-4 text-foreground leading-tight">
                {product.name}
              </h1>
            ...
            {/* Who It's For */}
            <div>
              <h2 className="text-xl mb-6 text-foreground">Who this is for</h2>
            ...
            {/* What's Included */}
            <div>
              <h2 className="text-xl mb-6 text-foreground">What's included</h2>
              <ul className="space-y-3">
            ...
            {/* Features */}
            <div>
              <h2 className="text-xl mb-6 text-foreground">Key Features</h2>
          ...
          <div className="col-span-1">
            <div className="sticky top-8 bg-card border border-border rounded-lg p-8 shadow-sm">
              <div className="mb-8">
